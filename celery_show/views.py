...
from celery_show import task
from celery_show import helper
from django.views.generic import FormView

from celery_show.forms import ContactFormModelForm
...
class ContactFormView(FormView):
    ...
    def send_email(self, valid_data):
        ...
        task.send_mail_task.delay(email, subject, message,)
